...
var require_html2 = __commonJS({
  "node_modules/hast-util-to-html/node_modules/property-information/html.js"(exports$1, module) {
    ...
    module.exports = merge2([xml2, xlink2, xmlns2, aria3, html5]);
  }
});
...
var require_svg2 = __commonJS({
  "node_modules/hast-util-to-html/node_modules/property-information/svg.js"(exports$1, module) {
    ...
    module.exports = merge2([xml2, xlink2, xmlns2, aria3, svg3]);
  }
});
  ...
  "node_modules/hast-util-to-html/node_modules/unist-util-is/convert.js"(exports$1, module) {
    ...
    function convert2(test) {
      ...
      if (typeof test === "object") {
        return ("length" in test ? anyFactory2 : matchesFactory)(test);
      }
  ...
  "node_modules/hast-util-is-element/convert.js"(exports$1, module) {
    ...
    function tagNameFactory(test) {
      ...
      function tagName(node2) {
        return element3(node2) && node2.tagName === test;
      }
    }
    function callFactory(test) {
      return call;
      function call(node2) {
        return element3(node2) && Boolean(test.apply(this, arguments));
      }
    }
    function element3(node2) {
      return node2 && typeof node2 === "object" && node2.type === "element" && typeof node2.tagName === "string";
    }
  }
});
...
var require_hast_util_is_element = __commonJS({
  "node_modules/hast-util-is-element/index.js"(exports$1, module) {
    ...
    function isElement(node2, test, index2, parent, context) {
...
var require_white_space_left = __commonJS({
  "node_modules/hast-util-to-html/lib/omission/util/white-space-left.js"(exports$1, module) {
    ...
    function whiteSpaceLeft(node2) {
      return isText(node2) && whiteSpace(node2.value.charAt(0));
    }
  }
});
  ...
  "node_modules/hast-util-to-html/lib/omission/omission.js"(exports$1, module) {
    ...
    function omission(handlers2) {
      ...
      function omit(node2, index2, parent) {
        var name = node2.tagName;
        var fn = own7.call(handlers2, name) ? handlers2[name] : false;
...
var require_closing = __commonJS({
  "node_modules/hast-util-to-html/lib/omission/closing.js"(exports$1, module) {
    ...
    var isComment = convert2("comment");
    ...
    function headOrColgroupOrCaption(node2, index2, parent) {
      ...
      return !next2 || !isComment(next2) && !whiteSpaceLeft(next2);
    }
    function html5(node2, index2, parent) {
      var next2 = after(parent, index2);
      return !next2 || !isComment(next2);
    }
    function body(node2, index2, parent) {
      var next2 = after(parent, index2);
      return !next2 || !isComment(next2);
    }
    function p(node2, index2, parent) {
      var next2 = after(parent, index2);
      return next2 ? element3(next2, clearParagraphSibling) : !parent || !element3(parent, confusingParagraphParent);
    }
    function li(node2, index2, parent) {
      var next2 = after(parent, index2);
      return !next2 || element3(next2, listItem3);
    }
    function dt(node2, index2, parent) {
      var next2 = after(parent, index2);
      return next2 && element3(next2, dataListItem);
    }
    ...
    function rubyElement(node2, index2, parent) {
      var next2 = after(parent, index2);
      return !next2 || element3(next2, ruby);
    }
    function optgroup(node2, index2, parent) {
      var next2 = after(parent, index2);
      return !next2 || element3(next2, optionGroup);
    }
    function option(node2, index2, parent) {
      var next2 = after(parent, index2);
      return !next2 || element3(next2, options);
    }
    function menuitem(node2, index2, parent) {
      var next2 = after(parent, index2);
      return !next2 || element3(next2, menuContent);
    }
    function thead(node2, index2, parent) {
      var next2 = after(parent, index2);
      return next2 && element3(next2, tableContainer);
    }
    ...
    function tr(node2, index2, parent) {
      var next2 = after(parent, index2);
      return !next2 || element3(next2, tableRow2);
    }
    function cells(node2, index2, parent) {
      var next2 = after(parent, index2);
      return !next2 || element3(next2, tableCell2);
    }
  }
});
...
var require_opening = __commonJS({
  "node_modules/hast-util-to-html/lib/omission/opening.js"(exports$1, module) {
    ...
    function html5(node2) {
      var head2 = first(node2);
      return !head2 || !isComment(head2);
    }
    function head(node2) {
      ...
      while (++index2 < length) {
        ...
        name = child.tagName;
        if (element3(child, uniqueHeadMetadata)) {
          if (own7.call(map3, name)) {
            return false;
          }
          map3[name] = true;
        }
    ...
    function body(node2) {
      var head2 = first(node2, true);
      return !head2 || !isComment(head2) && !whiteSpaceLeft(head2) && !element3(head2, meta);
    }
    function colgroup(node2, index2, parent) {
      var prev = before(parent, index2);
      var head2 = first(node2, true);
      if (element3(prev, "colgroup") && closing(prev, place(parent, prev), parent)) {
        return false;
      }
      return head2 && element3(head2, "col");
    }
    function tbody(node2, index2, parent) {
      var prev = before(parent, index2);
      var head2 = first(node2);
      if (element3(prev, tableContainers) && closing(prev, place(parent, prev), parent)) {
        return false;
      }
      return head2 && element3(head2, tableRow2);
    }
  }
});
...
var require_all = __commonJS({
  "node_modules/hast-util-to-html/lib/all.js"(exports$1, module) {
    ...
    function all3(ctx, parent) {
      var children2 = parent && parent.children;
      var length = children2 && children2.length;
      var index2 = -1;
      var results = [];
      while (++index2 < length) {
        results[index2] = one3(ctx, children2[index2], index2, parent);
      }
      return results.join("");
    }
  }
...
var require_stringify_entities = __commonJS({
  "node_modules/hast-util-to-html/node_modules/stringify-entities/index.js"(exports$1, module) {
    ...
    var defaultEscapes = toExpression2(escapes);
    var surrogatePair = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g;
    var bmp = /[\x01-\t\x0B\f\x0E-\x1F\x7F\x81\x8D\x8F\x90\x9D\xA0-\uFFFF]/g;
    function encode(value, options) {
      var settings = options || {};
      var subset = settings.subset;
      var set = subset ? toExpression2(subset) : defaultEscapes;
      var escapeOnly = settings.escapeOnly;
      var omit = settings.omitOptionalSemicolons;
      value = value.replace(set, replace2);
      ...
      function replace2(char, pos, val) {
        return one3(char, val.charAt(pos + 1), settings);
      }
    }
    function escape(value) {
      return encode(value, { escapeOnly: true, useNamedReferences: true });
    }
    function one3(char, next2, options) {
      ...
      var numeric;
      var decimal2;
      if ((shortest || options.useNamedReferences) && own7.call(characters, char)) {
        named = toNamed(characters[char], next2, omit, options.attribute);
      }
      if (shortest || !named) {
        code4 = char.charCodeAt(0);
        numeric = toHexReference(code4, next2, omit);
        if (shortest) {
          decimal2 = toDecimalReference(code4, next2, omit);
    ...
    function toNamed(name, next2, omit, attribute) {
      var value = "&" + name;
      if (omit && own7.call(legacy, name) && dangerous.indexOf(name) === -1 && (!attribute || next2 && next2 !== "=" && !alphanumerical(next2))) {
        return value;
      }
      return value + ";";
    }
    function toHexReference(code4, next2, omit) {
      var value = "&#x" + code4.toString(16).toUpperCase();
      return omit && next2 && !hexadecimal(next2) ? value : value + ";";
    }
    function toDecimalReference(code4, next2, omit) {
      var value = "&#" + String(code4);
      return omit && next2 && !decimal(next2) ? value : value + ";";
    }
    function toExpression2(characters2) {
...
var require_text = __commonJS({
  "node_modules/hast-util-to-html/lib/text.js"(exports$1, module) {
    ...
    function text7(ctx, node2, index2, parent) {
      var value = node2.value;
      return isLiteral(parent) ? value : entities(value, xtend(ctx.entities, { subset: ["<", "&"] }));
    }
    function isLiteral(node2) {
      return node2 && (node2.tagName === "script" || node2.tagName === "style");
    }
  }
});
...
var require_constants = __commonJS({
  "node_modules/hast-util-to-html/lib/constants.js"(exports$1, module) {
    ...
    var formFeed = "\f";
    var whitespace = [space2, tab2, lineFeed, carriageReturn, formFeed];
...
var require_element = __commonJS({
  "node_modules/hast-util-to-html/lib/element.js"(exports$1, module) {
    ...
    var spaces = require_space_separated_tokens().stringify;
    var commas = require_comma_separated_tokens().stringify;
    var entities = require_stringify_entities();
    ...
    var greaterThan = ">";
    var slash = "/";
    function element3(ctx, node2, index2, parent) {
      ...
      attrs = attributes(ctx, node2.properties);
      ...
      content3 = all3(ctx, root4);
      selfClosing = content3 ? false : selfClosing;
      if (attrs || !omit || !omit.opening(node2, index2, parent)) {
        value = lessThan + name + (attrs ? space2 + attrs : "");
    ...
    function attributes(ctx, props) {
      ...
      while (++index2 < length) {
        ...
        if (index2 !== length - 1 && last !== quotationMark && last !== apostrophe) {
          values[index2] = result + space2;
        }
      }
      return values.join("");
    }
    ...
    function attributeName(ctx, name) {
      ...
      var subset = constants.name[valid2][ctx.safe];
      return entities(name, xtend(ctx.entities, { subset }));
    }
    function attributeValue(ctx, key, value, info) {
      ...
      if (value || !ctx.collapseEmpty) {
        ...
        if (ctx.unquoted) {
          ...
          unquoted = entities(
            value,
            xtend(options, { subset, attribute: true })
          );
        }
        if (!ctx.unquoted || unquoted !== value) {
          if (alternative && ccount2(value, quote) > ccount2(value, alternative)) {
            quote = alternative;
          }
          subset = quote === apostrophe ? constants.single : constants.double;
          subset = subset[ctx.schema.space === "html" ? ctx.valid : 1][ctx.safe];
          value = entities(value, xtend(options, { subset, attribute: true }));
...
var require_raw = __commonJS({
  "node_modules/hast-util-to-html/lib/raw.js"(exports$1, module) {
    ...
    function raw(ctx, node2) {
      return ctx.dangerous ? node2.value : text7(ctx, node2);
    }
  }
});
...
var require_one = __commonJS({
  "node_modules/hast-util-to-html/lib/one.js"(exports$1, module) {
    ...
    var own7 = {}.hasOwnProperty;
    var handlers2 = {};
    handlers2.root = require_all();
    handlers2.text = require_text();
    handlers2.element = require_element();
    handlers2.doctype = require_doctype();
    handlers2.comment = require_comment();
    handlers2.raw = require_raw();
    function one3(ctx, node2, index2, parent) {
      var type = node2 && node2.type;
      if (!type) {
        throw new Error("Expected node, not `" + node2 + "`");
      }
      if (!own7.call(handlers2, type)) {
        throw new Error("Cannot compile unknown node `" + type + "`");
      }
      return handlers2[type](ctx, node2, index2, parent);
    }
  }
});
  ...
  "node_modules/hast-util-to-html/lib/index.js"(exports$1, module) {
    ...
    function toHtml(node2, options) {
      ...
      if (quote !== quotationMark && quote !== apostrophe) {
        throw new Error(
          "Invalid quote `" + quote + "`, expected `" + apostrophe + "` or `" + quotationMark + "`"
        );
      }
      return one3(
        {
          ...
          schema: settings.space === "svg" ? svg3 : html5,
...
function element(state, node2) {
  ...
  const result = x(node2.tagName, properties2, all(state, node2.childNodes));
...
function aaObtainFurthestBlock(p, formattingElementEntry) {
  ...
  for (; idx >= 0; idx--) {
    const element3 = p.openElements.items[idx];
    if (element3 === formattingElementEntry.element) {
      break;
    }
    if (p._isSpecialElement(element3, p.openElements.tagIDs[idx])) {
...
function genericEndTagInBody(p, token) {
  ...
  for (let i = p.openElements.stackTop; i > 0; i--) {
    ...
    const elementId = p.openElements.tagIDs[i];
    if (tid === elementId && (tid !== TAG_ID.UNKNOWN || p.treeAdapter.getTagName(element3) === tn)) {
      p.openElements.generateImpliedEndTagsWithExclusion(tid);
      if (p.openElements.stackTop >= i)
        p.openElements.shortenToLength(i);
      break;
    }
    if (p._isSpecialElement(element3, elementId)) {
      break;
    }
  }
}
...
function endTagInForeignContent(p, token) {
  ...
  for (let i = p.openElements.stackTop; i > 0; i--) {
    ...
    const tagName = p.treeAdapter.getTagName(element3);
...
var urlToHash = (url) => crypto.createHash("sha256").update(url).digest("hex").slice(0, 16);
var ensureCacheDir = async (cacheDir) => {
  try {
...
var loadCachedNotebook = async (cacheDir, url) => {
  try {
    const hash = urlToHash(url);
    const raw = await fs.readFile(default2.join(cacheDir, `${hash}.json`), "utf-8");
    return JSON.parse(raw);
  } catch {
    return null;
  }
};
var isCacheStale = async (url, timeout) => {
  try {
    let rawUrl = url;
...
var downloadNotebook = async (url, timeout) => {
  try {
    let rawUrl = url;
    if (url.includes("github.com") && !url.includes("raw.githubusercontent.com")) {
      rawUrl = url.replace("github.com", "raw.githubusercontent.com").replace("/blob/", "/");
...
// src/render.ts
var import_rehype_stringify = __toESM(require_rehype_stringify());
...
function safeProtocol(state, key, value) {
  const protocols = state.schema.protocols && own6.call(state.schema.protocols, key) ? state.schema.protocols[key] : void 0;
...
function patch3(node2, unsafe) {
  const cleanPosition = position3(
...
// src/registry.ts
var imageRegistry = /* @__PURE__ */ new Map();
var registerImages = (url, images) => {
...
var hasImages = () => imageRegistry.size > 0;

// src/render.ts
var escapeHtml = (text7) => text7.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;");
var markdownToHtml = async (markdown) => {
  try {
    const processor = unified().use(remarkParse).use(remarkGfm).use(remarkRehype, { allowDangerousHtml: false }).use(rehypeSanitize, defaultSchema).use(import_rehype_stringify.default);
...
var formatOutput = (output, cellIndex, outputIndex, urlHash, sourceUrl) => {
  if (output.output_type === "stream") {
    const text7 = Array.isArray(output.text) ? output.text.join("") : output.text;
    return `<div class="notebook-stream-output"><pre>${escapeHtml(text7)}</pre></div>`;
  }
  if (output.output_type === "execute_result" || output.output_type === "display_data") {
    ...
    if (output.data["text/plain"]) {
      const text7 = Array.isArray(output.data["text/plain"]) ? output.data["text/plain"].join("") : output.data["text/plain"];
      content3 += `<div class="notebook-text-output"><pre>${escapeHtml(text7)}</pre></div>`;
    }
    if (output.data["image/png"]) {
      const filename = `nb-${urlHash}-cell${cellIndex}-output${outputIndex}.png`;
      images.push({ filename, data: output.data["image/png"] });
      content3 += `<div class="notebook-image-output"><img src="notebook-assets/${filename}" alt="Plot output" /></div>`;
    }
    if (output.data["text/html"]) {
      const html5 = Array.isArray(output.data["text/html"]) ? output.data["text/html"].join("") : output.data["text/html"];
      const sanitized = html5.replace(/<script[\s\S]*?<\/script>/gi, "");
      content3 += `<div class="notebook-html-output">${sanitized}</div>`;
    }
    if (images.length > 0) {
...
var cellToHtml = async (cell, index2, urlHash, sourceUrl) => {
  ...
  if (cell.cell_type === "markdown") {
    ...
    content3 = `<div class="notebook-markdown-cell">${await markdownToHtml(source)}</div>`;
...
var convertToColabUrl = (githubUrl) => {
  try {
...
var notebookToHtml = async (notebook, sourceUrl, isCollapsed, opts) => {
  ...
  const cellCount = opts.showCellCount ? `<span class="notebook-cell-count">${notebook.cells.length} cells</span>` : "";
  return `
...
var NotebookEmbedding = (userOpts) => {
  ...
  return {
        ...
        () => {
          return async (tree, _file) => {
            ...
            visit(tree, "element", (node2) => {
              if (node2.tagName === "a" && node2.properties?.href) {
                  ...
                  const promise = (async () => {
                    try {
                      ...
                      if (notebook) {
                        ...
                        node2.children = notebookAst.children;
                      } else {
                        node2.properties = {
                          ...node2.properties,
    ...
    externalResources() {
      return {
        css: [{ content: notebook_default, inline: true }],
        js: [],
        additionalHead: []
      };
    }
...
var emitAssets = async (ctx) => {
  if (!hasImages()) return [];
  const outputPaths = [];
  const images = drainImages();
  const outputDir = default2.join(ctx.argv.output, "notebook-assets");
  await fs.mkdir(outputDir, { recursive: true });
  for (const [_url, fileList] of images) {
    for (const image3 of fileList) {
      const outputPath = joinSegments(ctx.argv.output, "notebook-assets", image3.filename);
      const buffer = Buffer.from(image3.data, "base64");
...
export { NotebookAssetsEmitter, NotebookEmbedding };
