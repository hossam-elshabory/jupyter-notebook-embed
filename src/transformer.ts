...
export const deterministicId = (url: string): string => {
...
const notebookToHtml = async (
  ...
  // Extract language from metadata, defaulting to python
                  ...
                  const promise = (async () => {
                    try {
                      ...
                      if (notebook) {
                        ...
                        node.children = notebookAst.children as Element["children"];
                      } else {
                        node.properties = {
                          ...node.properties,
